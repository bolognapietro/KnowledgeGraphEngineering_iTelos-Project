...
def aldeno():
    ...
    input_dir = 'Phase 2 - Information Gathering/data/cleaned/dati.trentino.it/csv/Aldeno.csv'
    output_dir = 'Phase 2 - Information Gathering/data/cleaned/dati.trentino.it/fixed_csv/Aldeno.csv'
